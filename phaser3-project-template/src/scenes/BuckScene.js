...
class BuckScene extends Phaser.Scene {
    constructor() {
        super('Buck');
        console.log('buck');
        this.graphics = null;
        ...
        this.cameraScroll = this.cameraScroll.bind(this);
        this.bullets = [];
        this.i = 0;
        this.addGun = false;
    ...
    create() {
        const width = this.cameras.main.width;
        const height = this.cameras.main.height;
        // this.camera = this.cameras.add(0, 0, 300, 300);
        ...
        this.deer = this.add.sprite(width/2,
            height * 0.8,
            'forestscene',
        ...
        this.gunUI();
        this.bulletsUI();
        this.scopeBG = this.add.sprite(width/2,
            height/2,
            'forestscene',
            '1280x728_scope.psd').setScale(4,4);
    }

    update() {
        console.log(this.deerCount);
        const width = this.cameras.main.width;
        const height = this.cameras.main.height;
    ...
    cameraScroll(gameObject) {
        console.log('camera scroll');
        // this.camera.startFollow(gameObject);
    }
